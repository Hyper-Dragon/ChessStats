...
namespace ChessStats
{
    ...
    public static class Helpers
    {
        ...
        public static string GetHtmlTop(string pageTitle, string backgroundImage)
        {
            ...
            _ = htmlReport.AppendLine("<!DOCTYPE html>")
                              ...
                              .AppendLine("     h2                                           {clear:left;padding: 5px;text-align: left;font-size: 20px;background-color: rgba(0,0,0,.13);color: hsla(0,0%,100%,.65);}")
                              .AppendLine("     table                                        {width: 100%;table-layout: fixed ;border-collapse: collapse; overflow-x:auto; }")
                              .AppendLine("     thead                                        {text-align: center;background: #769656;color: white;font-size: 14px; font-weight: bold;}")
