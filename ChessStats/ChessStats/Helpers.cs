    ...
    public static class Helpers
    {
        ...
        public static string GetHtmlTop(string pageTitle, string backgroundImage, string font700Fragment, string font800Fragment)
        {
            ...
            _ = htmlReport.AppendLine("<!DOCTYPE html>")
                          ...
                          .AppendLine("     thead                                        {font-family: Montserrat; font-weight: 800;text-align: center;background: #769656;color: white;font-size: 14px; font-weight: bold;}")
                          .AppendLine("     tbody                                        {font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif; text-align: center;font-size: 11px;}")
                          .AppendLine("     td                                           {padding-right: 0px;}")
                          .AppendLine("     tbody td:nth-child(n+2)                      {font-sytle:bold;}")
